...
- Read [TECH_SOURCES.json](references/TECH_SOURCES.json) for RSS, GitHub, Reddit sources
- Read [TECH_TOPICS.json](references/TECH_TOPICS.json) for topic definitions
- Read [TECH_FORMAT.md](references/TECH_FORMAT.md) for output format
- Read [SCORING.md](references/SCORING.md) for quality scoring rules
...
- Apply scoring formula from [SCORING.md](references/SCORING.md)
...
- Format per [TECH_FORMAT.md](references/TECH_FORMAT.md)
...
- Read [FORMAT.md](references/FORMAT.md) for output format (STRICT)
- Read [SOURCES.md](references/SOURCES.md) for approved media sources
...
- Format per [FORMAT.md](references/FORMAT.md)
...
- Read [PODCAST_PROMPT.md](references/PODCAST_PROMPT.md) for style guide
